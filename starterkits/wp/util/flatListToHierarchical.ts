/**
 * @file
 * Copied from Faust.js to allow for importing server-side
 * @see https://github.com/wpengine/faustjs/blob/canary/packages/faustwp-core/src/utils/flatListToHierarchical.ts
 */
